...
user.update_api_key!(:type => "application", :purpose => "To be more awesome.") # sets user to the updated object

# I want to delete an API key of a user
user.delete_api_key!("f938237a93e9393b365c3") # returns: true / exception
...
DataCatalog::User.find_by_api_key("f938237a93e9393b365c3") # returns: User object
